...
--
--   28 tables · 43 functions · 75 policies
--
-- Generated by tests/sql/build_schema.mjs on 2026-07-30
-- ============================================================
...
CREATE TABLE IF NOT EXISTS chat_folders (
  ...
  CONSTRAINT chat_folders_folder_check CHECK ((folder = ANY (ARRAY['all'::text, 'pinned'::text, 'study'::text, 'muted'::text, 'archived'::text])))
);
